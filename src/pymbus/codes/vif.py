...
class VIFCodeCategory(str, Enum):
...
class VIFCode:
    ...
    coef: int | float = 1
    desc: str = VIFCodeCategory.unknown
...
_VIF_CODE_MAP: dict[int, VIFCode] = {
    ...
    0b0010_0100: VIFCode(
        # code=0x24,
        coef=1,
        desc=VIFCodeCategory.operating_time,
        unit=VIFCodeUnit.second,
    ),
    0b0010_0101: VIFCode(
        # code=0x25,
    ...
    0b0011_1000: VIFCode(
        # code=0x38,
        coef=1e-6,
        desc=VIFCodeCategory.volume_flow,
    ...
    0b0101_0000: VIFCode(
        # code=0x50,
        coef=1e-3,
        desc=VIFCodeCategory.mass_flow,
    ...
    0b0101_1000: VIFCode(
        # code=0x58,
        coef=1e-3,
        desc=VIFCodeCategory.flow_temperature,
    ...
    0b0101_1100: VIFCode(
        # code=0x5C,
        coef=1e-3,
        desc=VIFCodeCategory.return_temperature,
        unit=VIFCodeUnit.celsius,
    ),
    0b0101_1101: VIFCode(
        # code=0x5D,
    ...
    0b0110_0000: VIFCode(
        # code=0x60,
        coef=1e-3,
        desc=VIFCodeCategory.temperature_difference,
    ...
    0b0110_0100: VIFCode(
        # code=0x64,
        coef=1e-3,
        desc=VIFCodeCategory.external_temperature,
        unit=VIFCodeUnit.celsius,
    ),
    0b0110_0101: VIFCode(
        # code=0x65,
    ...
    0b0110_1100: VIFCode(
        # code=0x6C,
        coef=1,
        desc=VIFCodeCategory.time_point,
    ...
    0b0110_1110: VIFCode(
        # code=0x6E,
        coef=1e0,
        desc=VIFCodeCategory.hca,
        unit=VIFCodeUnit.hca,
    ),
    # Reserved
    0b0110_1111: VIFCode(
        # code=0x6F,
        desc=VIFCodeCategory.reserved
    ),
    # E111_00nn - Averaging duration (in seconds)
    0b0111_0000: VIFCode(
        # code=0x70,
        coef=1,
        desc=VIFCodeCategory.averaging_duration,
        unit=VIFCodeUnit.second,
    ),
    0b0111_0001: VIFCode(
        # code=0x71,
    ...
    0b0111_0100: VIFCode(
        # code=0x74,
        coef=1,
        desc=VIFCodeCategory.actuality_duration,
        unit=VIFCodeUnit.second,
    ),
    0b0111_0101: VIFCode(
        # code=0x75,
    ...
    0b0111_1000: VIFCode(
        # code=0x78,
        desc=VIFCodeCategory.fabrication_no
    ),
    # E111_1001
    0b0111_1001: VIFCode(
        # code=0x79,
        desc=VIFCodeCategory.enhanced
    ),
    # E111_1010
    0b0111_1010: VIFCode(
        # code=0x7A,
        desc=VIFCodeCategory.bus_address
    ),
    # special purpose VIF codes
    0b0111_1100: VIFCode(
        # code=0x7C,
        desc=VIFCodeCategory.user
    ),
    0b0111_1110: VIFCode(
        # code=0x7E,
        desc=VIFCodeCategory.any
    ),
    0b0111_1111: VIFCode(
        # code=0x7F,
        desc=VIFCodeCategory.manufacturer
    ),
    # special purpose VIF codes
    0b1111_1011: VIFCode(
        # code=0xFB,
        desc=VIFCodeCategory.extension
    ),
    0b1111_1101: VIFCode(
        # code=0xFD,
        desc=VIFCodeCategory.extension
...
class VIFTablet:
    ...
    def __call__(self, value: int | VIF | VIFE) -> None | VIFCode:
        return self.get_vif_code(value)

    def get_vif_code(self, value: int) -> None | VIFCode:
